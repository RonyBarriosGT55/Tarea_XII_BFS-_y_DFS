...
package com.mycompany.analisis_tecnico_java_grafos.exe;

import java.util.*;

public class Analisis_tecnico_Java_GrafosExe { 
    private Map<Integer, List<Integer>> grafo;

    public Analisis_tecnico_Java_GrafosExe() { 
        grafo = new HashMap<>();
    }
    ...
    public static void main(String[] args) {
        Analisis_tecnico_Java_GrafosExe grafo = new Analisis_tecnico_Java_GrafosExe();
